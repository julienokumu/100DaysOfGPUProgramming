...
__global__ void wmma_batched(const half* A, const half* B, half* C, int M, int N, int K) {
...
__global__ void batched_matmul(const half* A, const half* B, half* C, int M, int N, int K) {
